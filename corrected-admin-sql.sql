-- CORRECTED SQL COMMANDS FOR ADMIN USER CREATION
-- Run these in Supabase SQL Editor AFTER creating the user in Authentication > Users

-- 1. Insert admin role (only if not already exists)
...
-- 2. Insert admin profile (only if not already exists)
